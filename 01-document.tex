...
\section{Introduction}
    ...
    velocities---with $1 \leqslant N \leqslant 4\}$, $K = L = N + 1$, and $M = 2N + 1$, i.e., SLB(1;~2,~2,~3),  SLB(2;~3,~3,~5),
    SLB(3;~4,~4,~7), and SLB(4;~5,~5,~9) are given in~\cite{2012-AmbrusVE+SofoneaV-PhysRevE}.
