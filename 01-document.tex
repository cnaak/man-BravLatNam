...
\section{Introduction}
    ...
    One driving application for  increased  velocity  count  lattices  is  solving  for  thermal  flows  using  LB  methods.  On
    ...
    magnitude and forming adjacent right angles, which led to possibly multiple sublattices per energy level $\varepsilon \equiv 2e
    = \xi^2$, with $\xi$ being the velocity magnitude, as was the case with the $\epsilon = 1^2 + 2^2 = 5$  energy  level  of  a
    square lattice, represented by the 8 discrete velocities $(\pm\{1,2\},\pm\{1,2\})$ in lattice units.
