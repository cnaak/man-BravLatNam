...
\section{Introduction}
    ...
    and $U$ is the (arbitrary) reference frame speed  shifting.  Better  still,  the  Galilean  invariance  property  allow  the
    construction of higher-order lattices through tensor products of lower-order  Galilean  invariant  ones,  whether  they  are
    shifted or not.
