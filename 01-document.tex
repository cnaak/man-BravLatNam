...
\section{Introduction}
    ...
    4, 8, 9, 16\}$, respectively---thus meaning without the energy levels corresponding to  the  weight  labeled  `1,'  for  the
    `(W1)', and to the weight labeled `6,' for the `(W6)' name variants (noticing that energy level does  not  necessarily  grow
    monotonically with weight numerical labeling); and (iv)~a fourth-order Hermite  ($N=4$)---and  eighth  algebraic  degree  of
    precision $n=8$ following~\cite{2006-ShanX+ChenH-JFluidMech}---D2V37 lattice, suitable for thermal flow LB simulations.
