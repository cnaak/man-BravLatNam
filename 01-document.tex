...
\section{Introduction}
    ...
    Burnett, and higher-order macroscopic equations---meaning progressively  higher-order  moments  of  the  Boltzmann  equation
    express progressively higher-order macroscopic thermohydrodynamic descriptions.  Moreover,  the  authors  demonstrated  that
    projecting the Boltzmann equation onto order-$N$ truncated tensorial  Hermite  polynomial~\cite{1949-GradH-CommPureApplMath}
    expansion bases, lead to discrete LB models of corresponding  order-$N$  moments  (and  corresponding  macroscopic  physical
    descriptions), since resulting expansion coefficients correspond to the velocity moments up to the chosen order.
