...
\section{Introduction}
    ...
    and D2V115H, the last three of fifth, sixth, and seventh order,  respectively,  and  D3V107  in~\cite{2010-HegeleLA-DrUFSC}.
    ...
    ones. Thus, multiphase flows became another application calling for multi-speed, higher-order  lattices.  In  fact,  shortly
    after the group published~\cite{2014-MattilaKK+PhilippiPC-SciWorldJ} prescribed abscissas derived D2V81 and D2V141 lattices,
    along with an equivalent, however far simpler form of the prescribed abscissas method in their Section 2.
