...
\section{Introduction}
    ...
    in~\cite{2006-ShanX+ChenH-JFluidMech}.    In    their    work,    the    authors    point    out    from     the     Kinetic
    theory~\cite{2011-HarrisS-Dover, 2003-LiboffRL-bookSpringer} that successive Chapman-Enskog approximations of the  Boltzmann
    equation obtain the Euler, Navier-Stokes, Burnett, and higher-order macroscopic equations.
