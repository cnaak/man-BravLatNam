...
\section{Introduction}
    ...
    considered as a quadrature problem, in the senses that (i)~weights $w_i$ for lattice velocities  $\pmb{\xi}_i$  would  be
    found so that moments of the discrete equilibrium mass distribution function $f^{eq}(\pmb{\xi}_i)$  would  exactly  match
