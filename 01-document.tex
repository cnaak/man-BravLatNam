...
\section{Introduction}
    ...
    Shan's: (i)~systematic approach for the discretization of the Boltzmann kinetic equation, able to derive many models
    (ii)~provided a clear and rigorous procedure for obtaining higher-order approximations to the continuum Boltzmann equation
