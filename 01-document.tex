...
\section{Introduction}
    ...
    referred to as ``$d$-dimensional $b$-bit $g$ lattice model'', with $d$ being the Euclidean space dimension, $b$ the  lattice
    velocity count, and $g$ a geometry term, such as ``triangular,'' etc.
