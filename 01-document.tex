...
\section{Introduction}
    ...
    4, 8, 9, 16\}$, respectively---thus without weights labeled `1' and  `6';  and  (iv)~a  fourth-order  Hermite  ($N=4$)---and
    eighth algebraic degree  of  precision  $n=8$  following~\cite{2006-ShanX+ChenH-JFluidMech}---D2V37  lattice,  suitable  for
