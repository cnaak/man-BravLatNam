...
\section{Introduction}
    ...
    The `D$d$Q$b^d$' notation---as in D$3$Q$5^3$, D$3$Q$7^3$, and D$3$Q$11^3$---which make it more apparent its  tensor  product
    extension from a lower dimension (entropic)  lattice  with  $b$  velocities~\cite{2006-ChikatamarlaSS+KarlinIV-PhysRevLett},
    appears in~\cite{2015-FrapolliN+KarlinIV-PhysRevE} in connection to compressible flow applications. In this scheme, if
    %
    \begin{align}
