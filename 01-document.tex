...
\section{Introduction}
    ...
    lattices~\cite{1992-QianYH+LallemandP-EurophysLett},  they  established~\cite{2006-ShanX+ChenH-JFluidMech}   the   following
    comparisons, which were off by a scaling factor: $D2Q9  \propto  E_{2,5}^{9}$,  $D3Q15  \propto  E_{3,5}^{15}$,  and  $D3Q19
    \propto E_{3,5}^{19}$.
