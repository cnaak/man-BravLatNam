...
\section{Introduction}
    ...
    The following `DdVb' lattices  were  derived  by  Ortiz~\cite{2007-OrtizCEP-DrUFSC},  under  Philippi's  supervision,  using
    prescribed abscissas  quadrature:  second-order  hexagonally  regular  (Bravais)  D2V7;  third-order  irregular,  i.e.,  not
    space-filling, D2V12; fourth-order irregular D2V19, D2V20, D2V21, and regular D2V37; fifth-order irregular  D2V28a,  D2V28b,
    and regular D2V53a and D2V53b; sixth-order regular D2V81. In three-dimensional Euclidean space, the following:  second-order
    ...
    Discussion on a plurality of lattices and lattice operations, based on  yet  another  higher-order  LB  theory  that  allows
    higher-\emph{dimension} lattices to be obtained from lower-dimensional ones (from as low as 1-D lattice basis), takes  place
