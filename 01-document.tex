...
\section{Introduction}
    ...
    sets\/}''~\cite{2006-ChikatamarlaSS+KarlinIV-PhysRevLett}; the `D2Q25-ZOT' lattice, obtained  by  extending  the  `D1Q5-ZOT'
    through a tensor product with itself, so that D2Q25-ZOT$\equiv($D1Q5-ZOT$) \otimes ($D1Q5-ZOT$)$.
