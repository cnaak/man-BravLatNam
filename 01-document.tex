...
\section{Introduction}
    ...
    (Navier-Stokes) description that, according  to  the  authors,  requires  a  third-order  Hermite  expansion---$N  \geqslant
    3$---\cite{2006-ShanX+ChenH-JFluidMech}, which corresponds to a quadrature with a degree of precision $n \geqslant 6$.
