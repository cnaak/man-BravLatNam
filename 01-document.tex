...
\section{Introduction}
    ...
    ``\texttt{1D5V},'' ``\texttt{2D16V},'' and ``\texttt{3D40V},'' were  introduced  in~\cite{1994-ChenY+AkiyamaM-PhysRevE}  for
    shock wave front structure and shear wave flow application cases.
