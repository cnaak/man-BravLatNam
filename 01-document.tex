...
\section{Introduction}
    ...
    %
    \begin{quote}
        [...]~$N$th-order approximation to the equilibrium distribution is required  when  $N$th-order  macroscopic  equilibrium
        moments are to be correctly described in LBM.
    \end{quote}
