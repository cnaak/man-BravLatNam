...
\section{Introduction}
    ...
    progressively higher-order thermohydrodynamic descriptions. Moreover, the authors demonstrated that projecting the Boltzmann
    equation onto a order-$N$ truncated tensorial Hermite polynomial~\cite{1949-GradH-CommPureApplMath} expansion basis, lead to
    discrete LB models of corresponding order-$N$ moments (and corresponding macroscopic physical descriptions), since resulting
    expansion coefficients correspond to the velocity moments up to the chosen order.
