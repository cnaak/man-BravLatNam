...
\section{Introduction}
    ...
    lattice~\cite{2008-ChikatamarlaSS+KarlinIV-CompPhysComm}, obtained  by  extending  the  `D1Q5-ZOT'
    through a tensor product with itself, so that D2Q25-ZOT$\equiv($D1Q5-ZOT$) \otimes ($D1Q5-ZOT$)$; the 
