...
\section{Introduction}
    ...
    velocities~\cite{2006-ChikatamarlaSS+KarlinIV-PhysRevLett}, appears in~\cite{2015-FrapolliN+KarlinIV-PhysRevE} in connection
    to compressible flow applications. In this scheme, if
    %
    \begin{align}
