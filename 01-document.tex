...
\section{Introduction}
    ...
    The year of 2006 is seemingly a landmark for multi-velocity, higher-order LB schemes, as evidenced by the appearance of  two
    key  publications,  namely  those  of  Shan  and   co-authors~\cite{2006-ShanX+ChenH-JFluidMech}   and   of   Philippi   and
    co-authors~\cite{2006-PhilippiPC+SurmasR-PhysRevE}.
    ...
    authors point out that successive Chapman-Enskog approximations of the Boltzmann equation obtain the  Euler,  Navier-Stokes,
    Burnett, and higher-order macroscopic equations---meaning progressively higher-order moments of the Boltzmann  equation  are
    progressively higher-order macroscopic thermohydrodynamic descriptions. Moreover, the authors demonstrated  that  projecting
    the Boltzmann equation onto a order-$N$ truncated tensorial Hermite polynomial~\cite{1949-GradH-CommPureApplMath}  expansion
    basis, lead to discrete LB models of corresponding order-$N$ moments (and corresponding macroscopic physical  descriptions),
    since resulting expansion coefficients correspond to the velocity moments up to the chosen order.
