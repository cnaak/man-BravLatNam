...
\section{Introduction}
    ...
    D2V25(W6), containing the energy levels $\xi^2 = \epsilon \in \{0, 2, 4, 8, 9, 16, 18\}$, and $\epsilon \in \{0, 1, 2, 4, 8,
    9, 16\}$, respectively, thus meaning without the energy levels corresponding to weights 1, for the `(W1)', and  6,  for  the
    `(W6)' variants.
