...
\section{Introduction}
    ...
    Additionally, reference~\cite{2006-ShanX+ChenH-JFluidMech} has established that Gauss-Hermite quadrature of the Boltzmann
    equation yield LB models with \emph{minimum velocity count} for a given Euclidean spacial dimension
