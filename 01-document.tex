...
\section{Introduction}
    ...
    In the Appendix of  reference~\cite{2006-ShanX+ChenH-JFluidMech},  the  authors  include  a  brief  discussion  on  deriving
    quadratures on predefined Cartesian abscissae, which is  the  main  requirement  for  higher-order,  space-filling,  Bravais
    lattices for non-interpolating, exact advection LB schemes.
